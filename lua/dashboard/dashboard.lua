...
local function setup_dashboard()
  ...
  glitch_dashboard.setup({
    ...
    menu = {
      ...
      { key = "p", icon = "󰊢", desc = "Projects", cmd = "Telescope projects" },
      { key = "r", icon = "󰋚", desc = "Recent Files", cmd = "Telescope oldfiles" },
      { key = "g", icon = "󰊢", desc = "Git Files", cmd = "Telescope git_files" },
      ...
      { key = "m", icon = "󱌣", desc = "Mason", cmd = "Mason" },
      { key = "c", icon = "󰒓", desc = "Config", cmd = "e $MYVIMRC" },
      { key = "s", icon = "󰔡", desc = "Sessions", cmd = "Telescope sessions" },
